...
// yoda
import fighter from "../../assets/yoda/Designer.png";
import fighttext from "../../assets/yoda/hoverme-removebg-preview.png";
import yodaBackground from "../../assets/yoda/colorfullmountain.jpeg";
    ...
    <div className="hero">
      <div className="heroCont">
        <div className="IntroSec">
          ...
          >
            <h1>
              Hi, I'm <span>Sahil Sagar</span>
            </h1>
            {/* <h1>Change your <span>thoughts</span> into reality.</h1> */}
            <p>A Full Stack web Developer</p>
            <h2>
              Enthusiastic and skilled web developer with hands-on experience
              gained through a dynamic internship. Proficient in ReactJs,
              NodeJs, ExpressJs, Mongodb, JavaScript, and responsive design
              principles, with a keen eye for user experience and interface
              aesthetics.
            </h2>
            <div className="buttonCont">
              <a href={resume} download={"Sahil_Kumar_Frontend_Developer.pdf"}>
                {" "}
                <button>
            ...
            <div className="stack">
              <div className="mongo">
                <div className="mongoImgCont">
                  <img src={mongoIcon} alt="mongo" />
                </div>
                <p>M</p>
              </div>
              <div className="express">
                <div className="expressImgCont">
                  <img src={expressIcon} alt="express" />
                </div>
                <p>E</p>
              </div>
              <div className="react">
                <div className="reactImgCont">
                  <img src={reactIcon} alt="react" />
                </div>
                <p>R</p>
              </div>
              <div className="node">
                <div className="nodeImgCont">
